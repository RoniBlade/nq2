...
bf_settings = Variable.get("si_fcst_evolution_fcst", deserialize_json=True)['config']
...
@dag(
    ...
    tags=['si_fcst_evolution_fcst', 'business_files', 'target']
)
def si_fcst_evolution_fcst_to_target():

    @task
    def t_1_si_fcst_evolution_fcst_to_target(settings_list: list):
    ...
    bf_to_target = t_1_si_fcst_evolution_fcst_to_target.expand(settings_list=bf_settings)
    bf_to_target

si_fcst_evolution_fcst_to_target()
