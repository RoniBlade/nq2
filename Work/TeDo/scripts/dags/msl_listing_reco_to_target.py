...
@dag(
    ...
    tags=['msl_listing_reco', 'business_files', 'target']
)
def msl_listing_reco_to_target():
    """
    DAG для перекладки данных из временной схемы в target_edw.MSL_listings_reco_msl
    """

    @task
    def load_msl_listing_reco_to_target():
        source_table = "loading_businessfiles.MSL_listings_reco_msl"
        target_table = "target_edw.MSL_listings_reco_msl"
    ...
    load_msl_listing_reco_to_target()

msl_listing_reco_to_target()
