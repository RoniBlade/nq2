...
bf_settings = Variable.get("master_file_product", deserialize_json=True)['config']
...
@dag(
    ...
    tags=['master_file_product', 'business_files', 'target']
)
def master_file_product_to_target():

    @task
    def t_1_master_file_product_to_target(settings_list: list):
        ...
        # Получение количества строк в целевой таблице
    ...
    bf_to_target = t_1_master_file_product_to_target.expand(settings_list=bf_settings)
    bf_to_target

master_file_product_to_target()
