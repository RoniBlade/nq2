...
import static com.evolveum.midpoint.repo.common.subscription.SubscriptionId.Type.DEVELOPMENT;
...
public class SubscriptionStateCache implements SystemConfigurationChangeListener, ClusteringAvailabilityProvider {
    ...
    private @NotNull SubscriptionState determineAndCacheSubscriptionState(OperationResult result) {
        try {
            ...
            var subscriptionId =SubscriptionId.forTesting(DEVELOPMENT,"1246900300000");
                    //SubscriptionId.parse(SystemConfigurationTypeUtil.getSubscriptionId(systemConfiguration));
