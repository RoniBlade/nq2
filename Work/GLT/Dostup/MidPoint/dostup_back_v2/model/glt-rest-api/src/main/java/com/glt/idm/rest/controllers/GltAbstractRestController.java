...
/**
 * Base REST controllers class providing common (utility) methods and logger.
 */
public class GltAbstractRestController {
    ...
    protected String controllerBasePath() {
        ...
        throw new NullPointerException("Base controllers URL could not be determined.");
    }
}
