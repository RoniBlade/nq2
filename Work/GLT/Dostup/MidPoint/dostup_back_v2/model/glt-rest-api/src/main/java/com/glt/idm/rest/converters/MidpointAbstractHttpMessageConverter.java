package com.glt.idm.rest.converters;/*
    ...
    protected void writeInternal(@NotNull T object, @NotNull HttpOutputMessage outputMessage)
       ...
       // String serializedForm;
        ...
        try {
            ...
            else if (object instanceof SearchResultList) {
                SearchResultList objectList = (SearchResultList) object;
                if(!objectList.getList().isEmpty()) {
                    serializedForm = "[";
                    for (Object obj:objectList.getList()) {
                        serializedForm = serializedForm.concat(serializer.serializeAnyData(obj, fakeQName)).concat(",");
                    }
