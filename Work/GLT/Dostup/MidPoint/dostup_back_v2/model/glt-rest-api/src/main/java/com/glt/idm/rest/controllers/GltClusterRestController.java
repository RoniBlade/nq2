...
@CrossOrigin
@RestController
@RequestMapping( "/api/glt/cluster" )
public class GltClusterRestController extends GltAbstractRestController {

    public static final String CLASS_DOT = GltClusterRestController.class.getName() + ".";
    ...
    public GltClusterRestController() {
        // nothing to do
    }
