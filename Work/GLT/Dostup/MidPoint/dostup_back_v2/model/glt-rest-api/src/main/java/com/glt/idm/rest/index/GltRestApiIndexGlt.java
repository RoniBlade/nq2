package com.glt.idm.rest.index;/*
...
import com.glt.idm.rest.controllers.GltAbstractRestController;
...
@RestController
@RequestMapping("/api" )
public class GltRestApiIndexGlt extends GltAbstractRestController {

    private final String contextPath;
    private final List<OperationInfo> uiRestInfo;

    public GltRestApiIndexGlt(
