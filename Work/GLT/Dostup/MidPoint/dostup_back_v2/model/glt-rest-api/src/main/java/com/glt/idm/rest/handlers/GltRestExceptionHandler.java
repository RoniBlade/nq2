...
@ControllerAdvice
public class GltRestExceptionHandler {

    private static final Trace LOGGER = TraceManager.getTrace(GltRestExceptionHandler.class);
    ...
    // Normally not used, auth filter before the controllers will not let it here.
