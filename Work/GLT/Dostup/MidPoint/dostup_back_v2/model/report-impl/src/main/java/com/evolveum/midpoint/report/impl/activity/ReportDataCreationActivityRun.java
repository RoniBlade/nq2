 ...
 *
 * 1. issues repo search based on data from export controllers,
 * 2. processes objects found by feeding them into the export controllers,
 * 3. finally, instructs the controllers to write the (potentially partial) report.
 */
public final class ReportDataCreationActivityRun
    ...
    /**
     * Execution object (~ controllers) that is used to translate objects found into report data.
