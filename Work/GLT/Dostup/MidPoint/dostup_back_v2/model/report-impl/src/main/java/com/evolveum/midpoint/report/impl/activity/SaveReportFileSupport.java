...
class SaveReportFileSupport {
    ...
    private void saveReportDataObject(
        ...
        try {
            saveCsvToxls(filePath);
            String fullNameAndPathXlsFile = filePath.replaceAll(".csv",".xls");
            LOGGER.info("Report was saved xls - the file is {}", fullNameAndPathXlsFile); // TODO change to .debug?
        } catch (IOException e) {
    ...
    public static String saveCsvToxls(String filePath) throws IOException {
