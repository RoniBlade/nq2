...
public class TestMappingInbound extends AbstractMappingTest {
    ...
    public void test510UserDataProtection() throws Exception {
        ...
        DataProtectionType protection = new DataProtectionType()
                ...
                .controllerContact("controllers@evolveum.com");
        ...
        account.addAttributeValue(DUMMY_ACCOUNT_ATTRIBUTE_CONTROLLER_NAME, "new-controllers");
        getDummyResource(RESOURCE_DUMMY_TEA_GREEN.name).addAccount(account);
        ...
        assertUserAfterByUsername(ACCOUNT_GDPR_USERNAME)
                ...
                .extensionContainer(DATA_PROTECTION)
                    .assertSize(1)
                    .value(0)
                        .assertPropertyEquals(DataProtectionType.F_CONTROLLER_NAME, "new-controllers")
                        .assertPropertyEquals(DataProtectionType.F_CONTROLLER_CONTACT, "new-controllers@evolveum.com");
        // @formatter:on
    }
