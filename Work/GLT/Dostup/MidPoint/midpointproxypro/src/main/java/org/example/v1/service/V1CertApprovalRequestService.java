...
@Slf4j
public class V1CertApprovalRequestService {

    private final String FUNCTION_NAME = "d_get_cert_approval";
    private final StructureService structureService;


        public Page<Map<String, Object>> getCertApprovalRequest(FilterRequest request, Pageable pageable) {
