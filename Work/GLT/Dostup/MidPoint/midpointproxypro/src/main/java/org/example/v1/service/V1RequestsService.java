...
@Slf4j
public class V1RequestsService {

    private final String FUNCTION_NAME = "d_get_request";
    private final StructureService structureService;

    public Page<Map<String, Object>> getRequest(FilterRequest request, Pageable pageable) {
