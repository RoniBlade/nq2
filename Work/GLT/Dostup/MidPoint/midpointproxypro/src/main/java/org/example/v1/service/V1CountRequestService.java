...
@Slf4j
public class V1CountRequestService {

    private final String FUNCTION_NAME = "d_get_count_request";
    private final JdbcRepository jdbcRepo;

    public Page<Map<String, Object>> getCountRequest(Pageable pageable, String param) {
