...
@Slf4j
public class V1UserAssignmentsGrafService {

    private final String FUNCTION_NAME = "d_get_assignment_graf";
    private final JdbcRepository jdbcRepo;

    public Page<Map<String, Object>> getUserAssignmentsGraf(Pageable pageable, String param) {
