...
@Slf4j
public class V1CaseInfoService {

    private final String FUNCTION_NAME = "d_get_case_info";
    private final JdbcRepository jdbcRepo;

    public Page<Map<String, Object>> getCaseInfo(Pageable pageable, String param) {
