...
@Slf4j
public class V1DelegationsMeService {

    private final String FUNCTION_NAME = "d_get_delegations_me";
    private final StructureService structureService;

    public Page<Map<String, Object>> getDelegationsMe(FilterRequest request, Pageable pageable) {
