...
EMAIL_TO = ["adam.latyrov@tedo.ru", "evgeniy.danilov@tedo.ru"]
...
queries = [
    ("Регламентированные отчеты (форма 1, форма 2) v1",
     {"url": "https://biqas.pepsico.fas.tedo.ru/api/dashboard/8/dashcard/35/card/58/query",
      "parameters": [
          {"type": "string/=", "value": ["RU03"], "id": "a70b1d0", "target": ["variable", ["template-tag", "comp"]]},
          {"type": "date/single", "value": "2023-04-01", "id": "94226b61",
    ...
    #  {"url": "https://biqas.pepsico.fas.tedo.ru/api/dashboard/9/dashcard/34/card/57/query",
    #   "parameters": [
    #       {"type": "string/=", "value": ["RU03"], "id": "3e76b7b", "target": ["variable", ["template-tag", "company"]]},
    #       {"type": "date/single", "value": "2023-04-01", "id": "3d40058b",
    #        "target": ["variable", ["template-tag", "date"]]},
    #       {"type": "string/=", "value": ["2022"], "id": "63eb572e",
    ...
    #                  {"type": "date/single", "value": "2023-03-31", "id": "4b402cbe",
    #                   "target": ["variable", ["template-tag", "end_date"]]},
    #                  {"type": "string/=", "value": ["RU03"], "id": "3c9da159",
    #                   "target": ["variable", ["template-tag", "comp"]]}], "dashboard_id": 2}),
    ...
    #                  {"type": "string/=", "value": ["Поставщик"], "id": "f58c1193",
    #                   "target": ["variable", ["template-tag", "ven_type"]]},
    #                  {"type": "string/=", "value": ["-"], "id": "bc353b5d",
    #                   "target": ["variable", ["template-tag", "lifnr"]]},
    #                  {"type": "string/=", "value": ["-"], "id": "c9d1da59",
    #                   "target": ["variable", ["template-tag", "kunnr"]]},
    ...
    #   "parameters": [
    #       {"type": "string/=", "value": ["RU03"], "id": "8eae91dd", "target": ["variable", ["template-tag", "bukrs"]]},
    #       {"type": "string/=", "value": ["2023"], "id": "26120b1d", "target": ["variable", ["template-tag", "year"]]},
    #       {"type": "string/=", "value": ["001"], "id": "b71f1e23", "target": ["variable", ["template-tag", "poper"]]},
    #       {"type": "string/=", "value": ["-"], "id": "a7cc424d", "target": ["variable", ["template-tag", "matnr"]]}],
    #   "dashboard_id": 11}
    #  ),
    # ("Регистр учета ВНА",
    #  {"url": "https://biqas.pepsico.fas.tedo.ru/api/dashboard/3/dashcard/25/card/41/query",
    #   "parameters": [
    #       {"type": "string/=", "value": ["RU03"], "id": "89e2a4dc", "target": ["variable", ["template-tag", "comp"]]},
    #       {"type": "string/=", "value": ["2023"], "id": "ee80025a", "target": ["variable", ["template-tag", "gjahr"]]},
    #       {"type": "string/=", "value": ["1"], "id": "f34efa12", "target": ["variable", ["template-tag", "peraf"]]},
    #       {"type": "string/=", "value": ["-"], "id": "ac0c5519", "target": ["variable", ["template-tag", "asset"]]},
    #       {"type": "string/=", "value": ["-"], "id": "3eea3ab9", "target": ["variable", ["template-tag", "as_sub"]]},
    #       {"type": "string/=", "value": ["-"], "id": "f73327a3", "target": ["variable", ["template-tag", "as_class"]]},
    #       {"type": "string/=", "value": ["-"], "id": "ddb0eb7", "target": ["variable", ["template-tag", "plant"]]}],
    #   "dashboard_id": 3}
    #  ),
    # ("Регистр учета РБП",
    #  {"url": "https://biqas.pepsico.fas.tedo.ru/api/dashboard/6/dashcard/26/card/44/query",
    #   "parameters": [
    #       {"type": "string/=", "value": ["RU03"], "id": "f7f28ca7", "target": ["variable", ["template-tag", "comp"]]},
    #       {"type": "date/single", "value": "2023-01-31", "id": "2199ae18",
    #        "target": ["variable", ["template-tag", "end_date"]]}, {"type": "string/=", "value": ["-"], "id": "85851c06",
    #                                                                "target": ["variable",
    #                                                                           ["template-tag", "acc_obj_cat"]]},
    #       {"type": "string/=", "value": ["-"], "id": "b7636ccd",
    #        "target": ["variable", ["template-tag", "acc_object"]]},
    #       {"type": "string/=", "value": ["-"], "id": "d73c5d2e",
    #        "target": ["variable", ["template-tag", "acc_obj_num"]]}], "dashboard_id": 6}
    #  ),
    ("Реестр бухгалтерских документов",
     {"url": "https://biqas.pepsico.fas.tedo.ru/api/dashboard/1/dashcard/37/card/62/query",
      "parameters": [{"type": "date/single", "value": "2023-01-01", "id": "d1d13059",
                      "target": ["variable", ["template-tag", "start_date"]]},
                     {"type": "date/single", "value": "2023-01-31", "id": "e0fe5040",
                      "target": ["variable", ["template-tag", "end_date"]]},
                     {"type": "string/=", "value": ["RU03"], "id": "b1059afc",
                      "target": ["variable", ["template-tag", "comp"]]},
                     {"type": "string/=", "value": ["0001000061"], "id": "fd95978e",
                      "target": ["variable", ["template-tag", "account"]]},
                     {"type": "string/=", "value": ["-"], "id": "3ed42146",
                      "target": ["variable", ["template-tag", "ven_type"]]},
                     {"type": "string/=", "value": ["-"], "id": "3007acad",
                      "target": ["variable", ["template-tag", "lifnr"]]},
                     {"type": "string/=", "value": ["-"], "id": "86342389",
                      "target": ["variable", ["template-tag", "kunnr"]]},
                     {"type": "string/=", "value": ["-"], "id": "552db31f",
                      "target": ["variable", ["template-tag", "blart"]]},
                     {"type": "string/=", "value": ["-"], "id": "c648212a",
                      "target": ["variable", ["template-tag", "belnr"]]}], "dashboard_id": 1}
     ),

    ("Карточка счета",
     {"url": "https://biqas.pepsico.fas.tedo.ru/api/dashboard/7/dashcard/17/card/14/query",
      "parameters": [{"type": "string/=", "value": ["0001000061"], "id": "fda9b4e4",
                      "target": ["variable", ["template-tag", "account"]]},
                     {"type": "string/=", "value": ["RU03"], "id": "38450c3e",
                      "target": ["variable", ["template-tag", "comp"]]},
                     {"type": "date/single", "value": "2023-01-01", "id": "a65cdd8c",
                      "target": ["variable", ["template-tag", "start_date"]]},
                     {"type": "date/single", "value": "2023-01-31", "id": "c6d91509",
                      "target": ["variable", ["template-tag", "end_date"]]}], "dashboard_id": 7}
     ),

    # ("План счетов",
    #  {"url": "https://biqas.pepsico.fas.tedo.ru/api/dashboard/4/dashcard/30/card/52/query",
    #   "parameters": [
    #       {"type": "string/=", "value": ["RU03"], "id": "50113db7", "target": ["variable", ["template-tag", "comp"]]},
    #       {"type": "string/=", "value": ["PI00"], "id": "a3333136", "target": ["variable", ["template-tag", "chart"]]}],
    #   "dashboard_id": 4}
    #  ),
    ...
    #       {"type": "date/single", "value": "2023-02-28", "id": "c44a508a",
    #        "target": ["variable", ["template-tag", "datum"]]},
...
def update_excel(all_results, request_details, existing_excel_path='report_results_dev.xlsx'):
...
def run_all_reports():
    ...
    if errors:
        ...
        send_email(EMAIL_SUBJECT, "Отчет выполнен успешно. См. вложение.", "report_results_dev.xlsx")
